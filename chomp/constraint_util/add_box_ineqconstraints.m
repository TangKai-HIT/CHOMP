function constraints = add_box_ineqconstraints( constraints, lb, ub, n )
%ADD_BOX_INEQCONSTRAINTS add box constraints to the inequality part of a chomp constraint struct 
