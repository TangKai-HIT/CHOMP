...
lb = [0.8, 0.4];
ub = [1.0, 0.6];
chomp2D.constraints = set_goal_boxconstraints( chomp2D.constraints, lb, ub, chomp2D.num_pt );
%plot constraint
rectangle('Position', [lb(1) lb(2) ub(1)-lb(1) ub(2)-lb(2)], 'EdgeColor', 'g', 'LineStyle', '--', 'LineWidth', 1.5);
